 ...
 * @param mu wheel-ground friction coefficient (used by Drake sim)
 */
data class MecanumParameters(
    ...
    fun toArray(): DoubleArray = doubleArrayOf(motor.freeSpeed, motor.stallTorque, lx,ly,wheelRadius,weight,rotInertia,cDragLin,cDragRot,mu)
}
