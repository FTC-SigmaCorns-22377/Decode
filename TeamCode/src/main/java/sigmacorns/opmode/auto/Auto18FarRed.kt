...
@Autonomous(name = "Auto 18 Far Red", group = "Competition")
class Auto18FarRed : SigmaOpMode() {
    companion object {
    ...
    override fun runOpMode() {
        ...
        val projectFile = TrajoptLoader.findProjectFiles(robotDir)
            .find { it.nameWithoutExtension == "18farredhp" }
            ?: throw IllegalStateException("18farredhp.json not found in $robotDir")
        ...
        val job = robot.scope.launch {
            ...
            // Shoot immediately before first path.
